...
#define SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                             24 // QList<QKeySequence >
...
#define SBK_QTGUI_QLIST_QOBJECTPTR_IDX                               38 // const QList<QObject * > &
#define SBK_QTGUI_QLIST_QUNDOSTACKPTR_IDX                            39 // QList<QUndoStack * >
#define SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                            40 // QList<QTextFrame * >
#define SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                               41 // QList<QTextBlock >
#define SBK_QTGUI_QLIST_QRECTF_IDX                                   42 // const QList<QRectF > &
#define SBK_QTGUI_QLIST_QGRAPHICSVIEWPTR_IDX                         43 // QList<QGraphicsView * >
#define SBK_QTGUI_QPAIR_QREAL_QPOINTF_IDX                            44 // QPair<qreal, QPointF >
#define SBK_QTGUI_QLIST_QPAIR_QREAL_QPOINTF_IDX                      45 // QList<QPair<qreal, QPointF > >
#define SBK_QTGUI_QPAIR_QREAL_QREAL_IDX                              46 // QPair<qreal, qreal >
#define SBK_QTGUI_QLIST_QPAIR_QREAL_QREAL_IDX                        47 // QList<QPair<qreal, qreal > >
#define SBK_QTGUI_QLIST_QABSTRACTBUTTONPTR_IDX                       48 // QList<QAbstractButton * >
...
#define SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                           51 // const QHash<int, QByteArray > &
#define SBK_QTGUI_QLIST_QACTIONPTR_IDX                               52 // QList<QAction * >
#define SBK_QTGUI_QLIST_QGRAPHICSWIDGETPTR_IDX                       53 // QList<QGraphicsWidget * >
#define SBK_QTGUI_QLIST_QWIDGETPTR_IDX                               54 // QList<QWidget * >
#define SBK_QTGUI_QLIST_QWIZARD_WIZARDBUTTON_IDX                     55 // const QList<QWizard::WizardButton > &
...
#define SBK_QTGUI_QLIST_QTABLEWIDGETITEMPTR_IDX                      58 // QList<QTableWidgetItem * >
#define SBK_QTGUI_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX               59 // QList<QTableWidgetSelectionRange >
#define SBK_QTGUI_QLIST_QLISTWIDGETITEMPTR_IDX                       60 // QList<QListWidgetItem * >

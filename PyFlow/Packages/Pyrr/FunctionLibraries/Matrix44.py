...
class Matrix44(FunctionLibraryBase):
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('Matrix44Pin', pyrr.Matrix44()), nodeType=NodeTypes.Pure, meta={'Category': 'Math|Matrix44', 'Keywords': []}, packageName=PACKAGE_NAME)
    def m44Zero():
        '''zero matrix44'''
        return pyrr.Matrix44()

    @staticmethod
    @IMPLEMENT_NODE(returns=('StringPin', str(pyrr.Matrix44())), meta={'Category': 'Math|Matrix44', 'Keywords': []}, packageName=PACKAGE_NAME)
    def m44ToStr(m=('Matrix44Pin', pyrr.Matrix44())):
        '''M44 to string.'''
        return str(m)

    @staticmethod
    @IMPLEMENT_NODE(returns=('Matrix44Pin', pyrr.Matrix44.identity()), nodeType=NodeTypes.Pure, meta={'Category': 'Math|Matrix44', 'Keywords': []}, packageName=PACKAGE_NAME)
    def m44Ident():
        '''Identity matrix44.'''
        return pyrr.Matrix44.identity()

    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatVector3Pin', pyrr.Vector3()), meta={'Category': 'Math|Matrix44', 'Keywords': ['matrix44']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('Matrix44Pin', pyrr.Matrix44()), meta={'Category': 'Math|Matrix44', 'Keywords': ['matrix44']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('Matrix44Pin', pyrr.Matrix44()), meta={'Category': 'Math|Matrix44', 'Keywords': ['create', 'matrix44']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('Matrix44Pin', pyrr.Matrix44()), meta={'Category': 'Math|Matrix44', 'Keywords': ['create', 'matrix44', 'quat']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=None, meta={'Category': 'Math|Matrix44', 'Keywords': ['create', 'matrix44']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatVector4Pin', pyrr.Vector4()), meta={'Category': 'Math|Matrix44', 'Keywords': ['matrix44']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Math|Matrix44', 'Keywords': ['matrix44']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('QuatPin', pyrr.Quaternion()), meta={'Category': 'Math|Matrix44', 'Keywords': ['matrix44']}, packageName=PACKAGE_NAME)

...
class Vector3(FunctionLibraryBase):
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatVector3Pin', pyrr.Vector3()), nodeType=NodeTypes.Pure, meta={'Category': 'Math|Vector3', 'Keywords': ['vector3']}, packageName=PACKAGE_NAME)
    def v3Create():
        '''Zero Vector3.'''
        v = pyrr.Vector3()
        return v
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatVector3Pin', pyrr.Vector3()), nodeType=NodeTypes.Pure, meta={'Category': 'Math|Vector3', 'Keywords': ['vector3', 'vector4']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('StringPin', str(pyrr.Vector3())), meta={'Category': 'Math|Vector3', 'Keywords': ['vector3']}, packageName=PACKAGE_NAME)
    def v3ToString(v=('FloatVector3Pin', pyrr.Vector3())):
        return str(v)

    @staticmethod
    @IMPLEMENT_NODE(returns=('BoolPin', True), nodeType=NodeTypes.Pure, meta={'Category': 'Math|Vector3', 'Keywords': ['lerp']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('BoolPin', True), nodeType=NodeTypes.Pure, meta={'Category': 'Math|Vector3', 'Keywords': ['vector3', '==']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), nodeType=NodeTypes.Pure, meta={'Category': 'Math|Vector3', 'Keywords': ['vector3', '|']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Math|Vector3', 'Keywords': ['vector3']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatVector3Pin', pyrr.Vector3()), meta={'Category': 'Math|Vector3', 'Keywords': ['vector3']}, packageName=PACKAGE_NAME)

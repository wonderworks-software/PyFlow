...
class Vector4(FunctionLibraryBase):
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatVector4Pin', pyrr.Vector4()), meta={'Category': 'Math|Vector4', 'Keywords': ['vector4']}, packageName=PACKAGE_NAME)
    def v4Create():
        '''Zero vector4.'''
        return pyrr.Vector4()

    @staticmethod
    @IMPLEMENT_NODE(returns=('StringPin', str(pyrr.Vector4())), meta={'Category': 'Math|Vector4', 'Keywords': ['vector4']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Math|Vector4', 'Keywords': ['vector4']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('BoolPin', True), meta={'Category': 'Math|Vector4', 'Keywords': ['vector4', '==']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Math|Vector3', 'Keywords': ['vector4']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Math|Vector4', 'Keywords': ['vector4', 'resize']}, packageName=PACKAGE_NAME)

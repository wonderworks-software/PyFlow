...
class Matrix33(FunctionLibraryBase):
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('Matrix33Pin', pyrr.Matrix33()), meta={'Category': 'Math|Matrix33', 'Keywords': ['create', 'matrix33']}, packageName=PACKAGE_NAME)
    ## Zero matrix33
    def m33Zero():
        '''Zero matrix33.'''
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('StringPin', str(pyrr.Matrix33())), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33']}, packageName=PACKAGE_NAME)
    ## Matrix33 to string
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('Matrix33Pin', pyrr.Matrix33.identity()), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33']}, packageName=PACKAGE_NAME)
    ## Identity matrix33
    def m33Ident():
        '''Identity matrix33.'''
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatVector3Pin', pyrr.Vector3()), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('QuatPin', pyrr.Quaternion()), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('Matrix44Pin', pyrr.Matrix44()), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('Matrix33Pin', pyrr.Matrix33()), meta={'Category': 'Math|Matrix33', 'Keywords': ['create', 'matrix33', 'quat']}, packageName=PACKAGE_NAME)
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('Matrix33Pin', pyrr.Matrix33()), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33', '*']}, packageName=PACKAGE_NAME)

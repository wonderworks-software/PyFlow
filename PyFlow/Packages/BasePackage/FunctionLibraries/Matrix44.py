...
class Matrix44(FunctionLibraryBase):
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Matrix44, pyrr.Matrix44()), nodeType=NodeTypes.Pure, meta={'Category': 'Math|Matrix44', 'Keywords': []})
    def m44Zero():
        '''zero matrix44'''
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.FloatVector3, pyrr.Vector3()), meta={'Category': 'Math|Matrix44', 'Keywords': ['matrix44']})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Matrix44, pyrr.Matrix44()), meta={'Category': 'Math|Matrix44', 'Keywords': ['matrix44']})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Matrix44, pyrr.Matrix44()), meta={'Category': 'Math|Matrix44', 'Keywords': ['create', 'matrix44']})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Matrix44, pyrr.Matrix44()), meta={'Category': 'Math|Matrix44', 'Keywords': ['create', 'matrix44', 'quat']})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Matrix44, pyrr.Matrix44()), meta={'Category': 'Math|Matrix44', 'Keywords': ['create', 'matrix44']})
    def m44OrthoProj(left=(DataTypes.Float, -5.0), right=(DataTypes.Float, 5.0), bottom=(DataTypes.Float, -5.0), top=(DataTypes.Float, 5.0), near=(DataTypes.Float, 0.0), far=(DataTypes.Float, 10.0), result=(DataTypes.Reference, (DataTypes.Bool, False))):
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Matrix44, pyrr.Matrix44()), meta={'Category': 'Math|Matrix44', 'Keywords': ['create', 'matrix44']})
    def m44PerspProjBounds(left=(DataTypes.Float, -5.0), right=(DataTypes.Float, 5.0), bottom=(DataTypes.Float, -5.0), top=(DataTypes.Float, 5.0), near=(DataTypes.Float, 0.0), far=(DataTypes.Float, 10.0), result=(DataTypes.Reference, (DataTypes.Bool, False))):
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.FloatVector4, pyrr.Vector4()), meta={'Category': 'Math|Matrix44', 'Keywords': ['matrix44']})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Float, 0.0), meta={'Category': 'Math|Matrix44', 'Keywords': ['matrix44']})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Quaternion, pyrr.Quaternion()), meta={'Category': 'Math|Matrix44', 'Keywords': ['matrix44']})

...
class MathLib(FunctionLibraryBase):
    ...
    # ###################
    @staticmethod
    @IMPLEMENT_NODE(returns=("AnyPin", 0, {"constraint": "1", "supportedDataTypes": ["FloatPin", "IntPin"]}), meta={'Category': 'Python|math|Number-theoretic and representation functions', 'Keywords': []})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=None, meta={'Category': 'Python|math|Number-theoretic and representation functions', 'Keywords': []})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Python|math|Number-theoretic and representation functions', 'Keywords': []})
    def ceil(x=('FloatPin', 0.0)):
        '''Return the ceiling of `x` as a float, the smallest integer value greater than or equal to `x`.'''
        return math.ceil(x)

    @staticmethod
    @IMPLEMENT_NODE(returns=('IntPin', 0), meta={'Category': 'Python|math|Number-theoretic and representation functions', 'Keywords': []})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('BoolPin', False), meta={'Category': 'Python|math|Number-theoretic and representation functions', 'Keywords': []})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Python|math|Power and logarithmic functions', 'Keywords': []})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Python|math|Trigonometry', 'Keywords': []})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Python|math|Angular conversion', 'Keywords': []})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Python|math|Hyperbolic functions', 'Keywords': []})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Python|math|Special functions', 'Keywords': []})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=('FloatPin', 0.0), meta={'Category': 'Python|math|Constants', 'Keywords': []})
    def e():

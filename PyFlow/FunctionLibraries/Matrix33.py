...
class Matrix33(FunctionLibraryBase):
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Matrix33, pyrr.Matrix33()), meta={'Category': 'Math|Matrix33', 'Keywords': ['create', 'matrix33']})
    ## Zero matrix33
    def m33Zero():
        '''Zero matrix33.'''
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.FloatVector3, pyrr.Vector3()), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33']})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Quaternion, pyrr.Quaternion()), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33']})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Matrix44, pyrr.Matrix44()), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33']})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Float, 0.0), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33']})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Matrix33, pyrr.Matrix33()), meta={'Category': 'Math|Matrix33', 'Keywords': ['create', 'matrix33', 'quat']})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Matrix33, pyrr.Matrix33()), meta={'Category': 'Math|Matrix33', 'Keywords': ['matrix33', '*']})

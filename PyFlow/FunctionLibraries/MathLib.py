...
class MathLib(FunctionLibraryBase):
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Float, meta={'Category': 'Math|Number-theoretic and representation functions', 'Keywords': []})
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Int, meta={'Category': 'Math|Number-theoretic and representation functions', 'Keywords': []})
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Bool, meta={'Category': 'Math|Number-theoretic and representation functions', 'Keywords': []})
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Float, meta={'Category': 'Math|Power and logarithmic functions', 'Keywords': []})
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Int, meta={'Category': 'Math|Bult-in functions', 'Keywords': ['+']})
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Float, meta={'Category': 'Math', 'Keywords': ['+', 'append']})
    def addf(A=(DataTypes.Float, 0.0), B=(DataTypes.Float, 0.0)):
        '''Sum of two flaots.'''
        return A + B

    @staticmethod
    @implementNode(returns=DataTypes.Int, meta={'Category': 'Math', 'Keywords': ['+', 'append']})
    def add(A=(DataTypes.Int, 0), B=(DataTypes.Int, 0)):
        '''Sum of two ints.'''
        return A + B

    @staticmethod
    @implementNode(returns=DataTypes.Int, meta={'Category': 'Math', 'Keywords': ['-']})
    def substract(A=(DataTypes.Int, 0), B=(DataTypes.Int, 0)):
        '''Int substraction.'''
        return A - B

    @staticmethod
    @implementNode(returns=DataTypes.Float, meta={'Category': 'Math', 'Keywords': ['-']})
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Float, meta={'Category': 'Math|Bult-in functions', 'Keywords': []})
    def absfloat(inp=(DataTypes.Float, 0.0)):
        '''Return the absolute value of a number.'''
        return abs(inp)

    @staticmethod
    @implementNode(returns=DataTypes.Float, meta={'Category': 'Math|Trigonometry', 'Keywords': []})
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Float, meta={'Category': 'Math|Angular conversion', 'Keywords': []})
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Float, meta={'Category': 'Math|Hyperbolic functions', 'Keywords': []})
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Float, meta={'Category': 'Math|Special functions', 'Keywords': []})
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Float, meta={'Category': 'Math|Constants', 'Keywords': []})
    def e():

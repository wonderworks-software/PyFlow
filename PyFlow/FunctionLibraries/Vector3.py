...
class Vector3(FunctionLibraryBase):
    ...
    @staticmethod
    @implementNode(returns=DataTypes.FloatVector3, nodeType=NodeTypes.Pure, meta={'Category': 'pyrr|Vector3', 'Keywords': []})
    def zeroVector3():
        '''zero Vector3'''
        v = pyrr.Vector3()
        return v
    ...
    @staticmethod
    @implementNode(returns=DataTypes.Bool, nodeType=NodeTypes.Pure, meta={'Category': 'pyrr|Vector3', 'Keywords': []})

...
#define SBK_PHONON_QPAIR_QBYTEARRAY_QSTRING_IDX                      6 // QPair<QByteArray, QString >
#define SBK_PHONON_QLIST_QPAIR_QBYTEARRAY_QSTRING_IDX                7 // QList<QPair<QByteArray, QString > >
#define SBK_PHONON_QLIST_INT_IDX                                     8 // QList<int >
#define SBK_PHONON_QHASH_QBYTEARRAY_QVARIANT_IDX                     9 // QHash<QByteArray, QVariant >
#define SBK_PHONON_QLIST_PHONON_OBJECTDESCRIPTION_PHONON_EFFECTTYPE__IDX 10 // const QList<Phonon::ObjectDescription<Phonon::EffectType > > &
#define SBK_PHONON_QMAP_INT_QVARIANT_IDX                             11 // QMap<int, QVariant >
#define SBK_PHONON_QHASH_INT_QBYTEARRAY_IDX                          12 // const QHash<int, QByteArray > &
#define SBK_PHONON_QLIST_PHONON_OBJECTDESCRIPTION_PHONON_AUDIOOUTPUTDEVICETYPE__IDX 13 // const QList<Phonon::ObjectDescription<Phonon::AudioOutputDeviceType > > &

...
#        @f$ \sqrt{4} @f$.
#
# @namespace sample_rawdocstring.sqrt4
def sqrt4():
    return 2
...
#        @f$\frac{1}{x}@f$.
#
# @namespace sample_rawdocstring.invert
def invert(x):
    return 1/x
...
class Polynomial(object):
    ...
    #
    # @namespace sample_rawdocstring.Polynomial.find_roots
    def find_roots(self):
        pass


## @brief Demonstrate polynomial class.
# @namespace sample_rawdocstring.main
def main():
